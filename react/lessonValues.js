const lessonValues = [
  ...
  },
  {
    ...
    syllabus: ['Πιο προχωρημένη HTML', 'Πολλά πρακτικά παραδείγματα'],
    url: 'html-advanced',
    isExercise: false,
  ...
  },
  {
    ...
    description:
      'Προχωρημένα θέματα της PHP. Μην ξεχάσετε <a href="http://web-class.gr/resources/sayit/">να δείτε το παράδειγμα</a> που δημιουργήσαμε μέσα στην τάξη, καθώς και να λύσεις τον <a href="http://web-class.gr/resources/sql-quiz/">SQL γρίφο</a>.',
    syllabus: [
  ...
  },
  {
    ...
    title: 'ΘΕΜΑΤΑ ΔΟΜΗΣ',
    description:
      'Η διάλεξη αφορά την σωστή συγγραφή κώδικα. <a href="http://web-class.gr/resources/sayit/indexmvc.php">Δείτε και την εφαρμογή που δημιουργήσαμε στο προηγούμενο μάθημα</a>, δομημένο σε με βάση το μοντέλο <a href="https://en.wikipedia.org/wiki/Model%E2%80%93view%E2%80%93controller">MVC</a>.',
    syllabus: [
  ...
  },
  {
    ...
    description:
      'Σχετικά με JavaScript Events. Παραθέτουμε ακόμη και κάποια <a href="http://web-class.gr/resources/events_examples">παραδείγματα</a> χρήσης των js events.',
    syllabus: [],
    url: 'js-events',
    isExercise: false,
  ...
  },
  {
    ...
    description:
      'Αντικειμενοστρεφής JavaScript και συναρτησιακός προγραμματισμός. <a href="http://web-class.gr/resources/animations/animation.html">Δείτε και το παράδειγμα</a> που παρουσιάστηκε στην διάλεξη.',
    syllabus: [],
    url: 'js-oop',
    isExercise: false,
  ...
  },
  {
    ...
    title: 'SUBVERSION',
    description:
      'Αποθήκευση αρχείου κώδικα με χρήση της τεχνολογίας subversion. Ωστόσο, το subversion θεωρείται πλέον ξεπερασμένο και στη θέση του χρησιμοποιείται το git. Μπορείτε να παρακάμψετε αυτή τη διάλεξη και αντ\' αυτού να μελετήσετε το git. Σας παραπέμπουμε στο μάθημά μας <a href="http://git-class.gr">git-class.gr</a>.',
    syllabus: [
